...
export function HeroSection({ content }: HeroSectionProps) {
  ...
  return (
    <section className="relative flex min-h-[70vh] overflow-hidden bg-stone-50 pb-20 pt-28 md:min-h-screen md:pb-32 md:pt-36">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-primary/[0.04] via-transparent to-amber-500/[0.03]" />
      <div className="pointer-events-none absolute -right-40 -top-40 h-[500px] w-[500px] rounded-full bg-primary/[0.06] blur-[100px]" />
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-80 w-80 rounded-full bg-amber-400/[0.05] blur-[80px]" />
      ...
      <div className="container relative mx-auto flex flex-1 items-center px-4">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-stone-500 md:text-xl"
          >
            {content.subheadline}
          </motion.p>
          ...
          {content.trustBadges && content.trustBadges.length > 0 && (
            <motion.div
              variants={itemVariants}
              className="mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 border-t border-stone-200 pt-8"
            >
